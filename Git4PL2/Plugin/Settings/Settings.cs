...
namespace Git4PL2.Plugin.Settings
{
    class Settings :ISettings
    {
        ...
        public string SQL_SERVERNAME => _PluginSettingsStorage.GetParamValue<string>(ePluginParameterNames.SQL_SERVERNAME);
        public bool TEAMCODING_ENABLE => _PluginSettingsStorage.GetParamValue<bool>(ePluginParameterNames.TEAMCODING_ENABLE);
        public string TEAMCODING_LOGIN => _PluginSettingsStorage.GetParamValue<string>(ePluginParameterNames.TEAMCODING_LOGIN);
        public bool TEAMCODING_RESTRICT_COMPILE_WITHOUT_CHECKOUT => _PluginSettingsStorage.GetParamValue<bool>(ePluginParameterNames.TEAMCODING_RESTRICT_COMPILE_WITHOUT_CHECKOUT);
        public int TEAMCODING_PROVIDER => _PluginSettingsStorage.GetParamValue<int>(ePluginParameterNames.TEAMCODING_PROVIDER);
        public string TEAMCODING_FILEPROVIDER_PATH => _PluginSettingsStorage.GetParamValue<string>(ePluginParameterNames.TEAMCODING_FILEPROVIDER_PATH);
        public string TEAMCODING_SERVERNAME_REGEX => _PluginSettingsStorage.GetParamValue<string>(ePluginParameterNames.TEAMCODING_SERVERNAME_REGEX);
    }
}
